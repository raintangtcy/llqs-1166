...
from header_operations import call_script, val_add
...
#             (troop_add_item, "trp_player","itm_forest_hunter",0),
#             (troop_add_item, "trp_player","itm_sword_of_guard",0),
#             (troop_add_item, "trp_player","itm_nordic_elite_battle_axe",0),
#             (troop_add_item, "trp_player","itm_nordic_guard_sword",0),
#             (troop_add_item, "trp_player","itm_nordic_rush_axe",0),
#             (troop_add_item, "trp_player","itm_bolts_acb",imodbit_large_bag),
#             (troop_add_item, "trp_player","itm_jigong",0),
#             (troop_add_item, "trp_player","itm_light_arrows",imodbit_large_bag),
#             (troop_add_item, "trp_player","itm_flintlock_pistol_con",0),
#             (troop_add_item, "trp_player","itm_cartridges222",0),
...
##  ),
  ...
  #new start_game start
    ("start_game_new",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    "Quick Start...",
    "none",
    [],
    [
   ...
   [
        ...
        ("mod_add_reputation",[],"Add 20 reputation to player.",
            [
                ...
                (val_add, ":player_renown", 20),
                (troop_set_slot, "trp_player", slot_troop_renown, ":player_renown"),
                (display_message, "@ add 20 renown to player"),
            ]
        ),
        #减少玩家声望
        ("mod_add_reputation_minus",[],"Minus 20 reputation to player.",
            [
                (troop_get_slot, ":player_renown","trp_player", slot_troop_renown ),
                (val_sub, ":player_renown", 20),
                (troop_set_slot, "trp_player", slot_troop_renown, ":player_renown"),
                (display_message, "@ remove 20 renown from player"),
            ]
        ),
        #增加玩家荣誉
        ("mod_add_honor",[],"Add 20 honor to player.",
            [
...
##  ),
  ...
  (
    ...
    [
      ...
      ("recruit_llqs_man",
      [
            (call_script, "script_cf_check_llqs_follower_condition_for_village"),
       ]
       ,"Recruit LLQS followers.",
       [
           (call_script, "script_village_recruit_llqs_man_recruit"),
        ]),
