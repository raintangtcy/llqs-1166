...
presentations = [
(
    "renown_ranking",prsntf_read_only, 0,
    [
        (ti_on_presentation_load,
            [
                (set_fixed_point_multiplier, 1000),
                 
                (create_text_overlay, reg0, r"@名 人 榜", tf_center_justify|tf_single_line|tf_with_outline),
                (overlay_set_color, reg0, 0xFFFF0000),
                ...
                (try_for_range, ":unused", active_npcs_begin, active_npcs_end),
                    ...
                    (assign, ":most_gold_remaining_npc", -1),
                    (try_for_range, ":active_npc", active_npcs_begin, active_npcs_end),
                        (troop_slot_eq, ":active_npc", slot_troop_temp_slot, 0),
                        (troop_get_slot,":npc_gold",":active_npc",slot_troop_renown),
                        (ge, ":npc_gold", ":score_to_beat"),
                        
                        (assign, ":score_to_beat", ":npc_gold"),
                        (assign, ":most_gold_remaining_npc", ":active_npc"),
                    (try_end),
                    (gt, ":most_gold_remaining_npc", -1),
                    
                    (str_store_troop_name, s4, ":most_gold_remaining_npc"),
                    (assign, reg4, ":score_to_beat"),
                    (str_store_string, s1, "@{reg2}. {s4}"),
                    (str_store_string, s2, "@声 望 值 {reg4}"),
                    (troop_set_slot, ":most_gold_remaining_npc", slot_troop_temp_slot, 1),
                    
                    (create_text_overlay, reg0, r"@{s1}", tf_left_align|tf_single_line|tf_with_outline),
                    (try_begin),
                        (lt, reg2, 11),
                        (overlay_set_color, reg0, 0xFF00FF00),
                    (else_try),
                    ...
                    (create_text_overlay, reg0, r"@{s2}", tf_left_align|tf_single_line|tf_with_outline),
                    (try_begin),
                        (lt, reg2, 11),
                        (overlay_set_color, reg0, 0xFF00FF00),
                    (else_try),
