...
(agent_get_party_id,":var_11",":var_1"),
(agent_get_position,pos3,":var_1"),
(try_for_agents,":var_2"),
    (agent_get_position,pos2,":var_2"),
    (get_distance_between_positions_in_meters,":var_3",pos2,pos3),
    (agent_get_party_id,":var_21",":var_2"),
    (try_begin),
        (neg|gt,":var_3",2),
        (neg|eq,":var_11",":var_21"),
        (agent_deliver_damage_to_agent,":var_1",":var_2",10),
    (try_end),
(try_end),
