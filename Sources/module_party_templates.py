...
##  ("kingdom_5_reinforcements_c", "kingdom_5_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_rhodok_sergeant,3,7),(trp_rhodok_veteran_spearman,2,5),(trp_rhodok_veteran_crossbowman,2,5)]),
  ...
  #quest smith start
  ("looters_smith","Looters Robbed the Smith",icon_axeman|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_looter,10,10), (trp_mountain_bandit,1,1), (trp_mountain_bandit,5,5)]),
  #qeust smith end
]
