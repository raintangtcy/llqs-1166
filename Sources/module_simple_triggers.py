...
#通过全局变量控制， 只出触发一次。检查玩家声望是否达到300，若达到，则提示可以到村庄招募追随者
    1,
    [
        (eq, "$g_check_play_renown_300", 0),
        (troop_get_slot, ":play_renown", "trp_player", slot_troop_renown),
        (gt, ":play_renown", 300),
        (display_message, "str_llqs_folowers_appear"),
        (assign, "$g_check_play_renown_300", 1),
    ]
),
  ...
  (72,
   [
     ...
     (try_for_range, ":village_no", villages_begin, villages_end),
       ...
       (call_script, "script_update_llqs_follower_troops_in_village", ":village_no"),
