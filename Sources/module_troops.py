...
#Player history array
  ...
  ["llqs_qiangqibing_duizhang","LLQS Lancer Captain","LLQS Lancer Captains",
   ...
   0,0,
   fac_player_faction,
   [itm_heavy_lance,itm_sword_medieval_d_long,itm_morningstar,itm_morningstar,itm_tab_shield_heater_cav_b,
    itm_coat_of_plates_red,itm_cuir_bouilli,itm_plate_boots,itm_guard_helmet,itm_great_helmet,itm_bascinet,itm_charger,itm_warhorse,itm_gauntlets,itm_mail_mittens],
   def_attrib|level(28),
   wp_one_handed (150) | wp_two_handed (130) | wp_polearm (130) | wp_archery (75) | wp_crossbow (75) | wp_throwing (75),knows_common|knows_riding_5|knows_shield_5|knows_ironflesh_5|knows_power_strike_5,swadian_face_middle_1, swadian_face_older_2
   ],
  ...
  ["llqs_jinshen_qibing_shiwei","LLQS Horse Bodyguard","LLQS Horse Bodyguards",
   ...
   0,0,
   fac_player_faction,
   [itm_sword_two_handed_b,itm_sword_medieval_d_long,itm_morningstar,itm_morningstar,itm_sword_medieval_d_long,itm_tab_shield_heater_cav_b,
    itm_coat_of_plates_red,itm_cuir_bouilli,itm_plate_boots,itm_guard_helmet,itm_great_helmet,itm_bascinet,itm_charger,itm_warhorse,itm_gauntlets,itm_mail_mittens],
   def_attrib|level(27),
   wp_one_handed (150) | wp_two_handed (130) | wp_polearm (130) | wp_archery (75) | wp_crossbow (75) | wp_throwing (75),knows_common|knows_riding_5|knows_shield_5|knows_ironflesh_5|knows_power_strike_5,swadian_face_middle_1, swadian_face_older_2
   ],
  ...
  ["llqs_feifubing","LLQS Throwaxeman","LLQS Throwaxemen",
   ...
   [itm_one_handed_war_axe_b,itm_throwing_axes,itm_throwing_axes,itm_one_handed_battle_axe_a,itm_tab_shield_round_c,
    itm_nordic_footman_helmet,itm_nordic_fighter_helmet,itm_mail_shirt,itm_studded_leather_coat,itm_hunter_boots,itm_leather_boots],
   def_attrib|level(20),
   wp_one_handed (80) | wp_two_handed (70) | wp_polearm (70) | wp_archery (70) | wp_crossbow (70) | wp_throwing (130),
   knows_ironflesh_4|knows_power_strike_4|knows_power_throw_3|knows_athletics_4|knows_shield_3,nord_face_young_1, nord_face_older_2],
  #资深飞斧兵
  ["llqs_zishen_feifubing","LLQS Veteran Throwaxeman","LLQS Veteran Throwaxemen",
   tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield|tf_guarantee_helmet,0,0,fac_player_faction,
   [itm_heavy_throwing_axes,itm_one_handed_battle_axe_b,itm_spiked_mace,itm_tab_shield_round_d,itm_javelin,itm_throwing_axes,
    itm_nordic_helmet,itm_nordic_fighter_helmet,itm_mail_hauberk,itm_mail_shirt,itm_splinted_leather_greaves,itm_leather_boots,itm_leather_gloves],
   def_attrib|level(23),
   wp_one_handed (130) | wp_two_handed (115) | wp_polearm (115) | wp_archery (115) | wp_crossbow (115) | wp_throwing (150),
   knows_ironflesh_5|knows_power_strike_5|knows_power_throw_5|knows_athletics_5|knows_shield_4,nord_face_young_1, nord_face_older_2],
  #长矛兵
  ["llqs_changmaobing","LLQS Spearman","LLQS Spearmen",
   ...
   [itm_ashwood_pike,itm_glaive,itm_tab_shield_pavise_c,
    itm_kettle_hat,itm_mail_coif,itm_mail_with_tunic_green,itm_leather_boots,itm_splinted_leather_greaves,itm_leather_gloves],
   def_attrib|level(19),wp_one_handed (80) | wp_two_handed (70) | wp_polearm (130) | wp_archery (70) | wp_crossbow (70) | wp_throwing (115),knows_common|knows_ironflesh_5|knows_shield_3|knows_power_strike_4|knows_athletics_3,rhodok_face_young_1, rhodok_face_older_2],
  #资深长矛兵
  ["llqs_zishen_changmaobing","LLQS Veteran Spearman","LLQS Veteran Spearmen",
   tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet|tf_guarantee_shield,0,0,fac_player_faction,
   [itm_ashwood_pike,itm_glaive,itm_tab_shield_pavise_c,
    itm_kettle_hat,itm_mail_coif,itm_mail_with_tunic_green,itm_leather_boots,itm_splinted_leather_greaves,itm_leather_gloves],
   def_attrib|level(22),wp_one_handed (125) | wp_two_handed (115) | wp_polearm (145) | wp_archery (115) | wp_crossbow (115) | wp_throwing (115),knows_common|knows_ironflesh_5|knows_shield_3|knows_power_strike_4|knows_athletics_3,rhodok_face_young_1, rhodok_face_older_2],
  #近身侍卫
  ...
  ["llqs_kuangzhanshi","LLQS Berserker","LLQS Berserkers",
   tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield|tf_guarantee_helmet,0,0,fac_player_faction,
   [itm_great_axe,itm_plate_armor,itm_winged_great_helmet,itm_mail_boots,itm_mail_chausses,itm_mail_mittens],
 ...
 ["llqs_qisheshou","LLQS Horse Archer","LLQS Horse Archers",
  ...
  ["llqs_jujishou","LLQS Snipper","LLQS Snippers",
   tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet|tf_guarantee_ranged|tf_guarantee_shield,0,0,fac_player_faction,
   [itm_military_hammer,itm_tab_shield_pavise_c,itm_sniper_crossbow,itm_steel_bolts,
    itm_flat_topped_helmet,itm_mail_coif,itm_mail_and_plate,itm_leather_boots,itm_splinted_leather_greaves],
   str_14 | agi_5 | int_4 | cha_4|level(23),wp_one_handed (120) | wp_two_handed (100) | wp_polearm (100) | wp_archery (100) | wp_crossbow (170) | wp_throwing (100),
  ...
  ["llqs_shenjianshou","LLQS Marksman","LLQS Marksmen",
   ...
   [itm_khergit_arrows,itm_axe,itm_khergit_arrows,itm_war_bow,itm_war_bow,itm_mail_with_tunic_green,
    itm_leather_vest,itm_leather_boots,itm_kettle_hat],
   str_14 | agi_5 | int_4 | cha_4|level(24),
   wp_one_handed (80) | wp_two_handed (130) | wp_polearm (80) | wp_archery (190) | wp_crossbow (80) | wp_throwing (80),
   knows_ironflesh_2|knows_power_draw_6|knows_athletics_3|knows_power_throw_1,
