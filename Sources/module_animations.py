...
from header_skills import knows_persuasion_5
...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_staff", 0, amf_client_prediction,
   ...
   [12.0, "spearcharge", 68, 65, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],
   [10.0, "spearwall_y", 4, 5, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],
 ],
 ...
 ["kick_right_leg", acf_enforce_all, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
##   [1.09, "jump", 22, 48, arf_blend_in_1],
   [0.7, "kick_leftleg_y2", 22, 2, arf_blend_in_1],
   [0.7, "kick_leftleg_y2", 2, 22, arf_blend_in_1],
   [0.7, "kick_leftleg_y", 1, 20, arf_blend_in_1],
   [0.7, "kick_leftleg", 13, 32, arf_blend_in_1],
   [0.7, "shield_bash_3", 1, 33, arf_blend_in_1],
   [0.7, "shield_bash", 1, 33, arf_blend_in_1],
   [0.7, "kick_rightleg_y", 12, 33, arf_blend_in_1],
 ],
...
#   [0.8, "run_normal", 0, 12, arf_use_walk_progress|arf_cyclic|blend_in_walk,pack2f(0.4,0.9)],
   [0.8, "run_man_forward_onehanded_y", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
##   [0.8, "run_greatsword", 0, 22, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [0.8, "run_forward_greatsword_y", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
# ],
 ...
 ["lancer_ride_4_no_shield",  acf_enforce_lowerbody | acf_synch_with_horse | acf_rot_vertical_sword|acf_anim_length(30), amf_rider_rot_couched_lance|amf_client_prediction|amf_priority_ride|amf_play,
   [5.5, "attacks_staff_lefttoright_y", 33, 33, arf_cyclic | arf_blend_in_128],
 ],
...
##   [4.0, "anim_human", horse_move + 5000, horse_move + 5057, arf_lancer|arf_cyclic],
 ...
 ["equip_greatsword", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   [1.0, "parry_attack_slashright_onehanded_yb", 48, 58, arf_blend_in_0],
 ...
 ["equip_axe_left_hip", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   ...
   [1.4, "parry_attack_slashright_onehanded_y", 46, 61, arf_blend_in_0],
 ],
 ...
 ["equip_dagger_front_left", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   [0.6, "equip_arms", 253, 276, arf_blend_in_0],
   [1.0, "parry_attack_slashright_onehanded_y", 46, 61, arf_blend_in_0],
 ],
 ...
 ["equip_revolver_right", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   ...
   [0.7, "parry_attack_slashright_onehanded_y", 52, 61, arf_blend_in_0],
 ],
...
##   [0.3, "anim_human", combat+10, combat+0, arf_blend_in_0],
 ...
 ["equip_wakizashi", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   [0.6, "equip_sword", 0, 27, arf_blend_in_0],
 ],
...
# duration and controlled via weapon speed.
 ["ready_bow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_bow,
   [1.5, "Archery_full", 16, 133, blend_in_ready|arf_make_custom_sound, pack2f(0.14, 0.44)],
 ],
 ["release_bow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_bow,
   [0.3, "Archery_full", 133, 174, arf_blend_in_2],
 ],
 #not used
 ...
 ["ready_throwing_knife", acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.5, "attacks_single_lefttoright", 4, 11, blend_in_ready],
   [0.5, "attacks_single_lefttoright_v7", 7, 18, blend_in_ready],
   [0.5, "throw_stone", 30, 40, blend_in_ready],
   [0.5, "parry_attack_slashleft_onehanded_y2", 31, 26, blend_in_ready],
 ],
 ["release_throwing_knife", acf_rot_vertical_bow, amf_priority_throw|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.8, "attacks_single_lefttoright", 18, 47, 6],
   [0.79, "parry_attack_slashleft_onehanded_y2", 27, 43, 6],
   [0.8, "attacks_single_lefttoright_y", 6, 31, 6],
   [0.79, "parry_attack_slashleft_onehanded", 28, 41, 6],
   [0.8, "attacks_single_lefttoright_horseback", 26, 50, 6],
 ],
...
##   [0.9, "throw_axe", 40, 90, arf_blend_in_0],
   ...
   [0.9, "throw_axe", 40, 90, arf_blend_in_0],
   [1.0, "throwing_stone", 20, 65, arf_blend_in_0],
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
 ...
 ["release_swingright_fist", 0, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right,
   ...
   [0.49, "straight_fist_y3", 14, 30, blend_in_release],
 ],
 ...
 ["ready_uppercut_fist", 0, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_thrust,
   [ready_durn, "upper_fist_y", 0, 8, blend_in_ready],
 ],
 ["release_uppercut_fist", 0, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust,
   [0.45, "upper_fist_y", 11, 27, blend_in_release],
   [0.4, "upper_fist_y2", 11, 24, blend_in_release],
 ],
...
##   [ready_durn, "slashright_twohanded", 10, 16, blend_in_ready],
   ...
   [ready_durn, "slashright_twohanded0", 5, 21, blend_in_ready],
   [ready_durn, "slashleft_twohanded2", 60, 50, blend_in_ready],
   [ready_durn, "slashleft_twohanded3", 35, 41, blend_in_ready],
   [ready_durn, "slashright_twohanded_y4", 0, 15, blend_in_ready],
 ],
...
##   [0.62, "slashright_twohanded", 16, 40, blend_in_release],
   ...
   [0.61, "slashright_twohanded_y", 29, 50, blend_in_release],
   [0.58, "slashright_twohanded_y3", 34, 54, blend_in_release],
   [0.61, "slashright_twohanded_y4", 15, 36, blend_in_release],
 ],
...
##   [0.3, "slashright_twohanded", 45, 61, blend_in_continue],
 ...
 ["ready_slashleft_twohanded", acf_right_cut|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
   ...
   [ready_durn, "slashleft_twohanded0", 7, 26, blend_in_ready],
   [ready_durn, "slashleft_twohanded2", 9, 23, blend_in_ready],
   [ready_durn, "slashleft_twohanded_y3", 11, 20, blend_in_ready],
   [ready_durn, "slashleft_twohanded_y4", 15, 23, blend_in_ready],
   [ready_durn, "ani_twohanded", 62, 71, blend_in_ready],
 ],
 ["release_slashleft_twohanded", acf_right_cut|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
   ...
   [0.61, "slashleft_twohanded0", 26, 48, blend_in_release],
   [0.61, "slashleft_twohanded2", 20, 40, blend_in_release],
   [0.52, "slashleft_twohanded_y", 20, 35, blend_in_release],
   [0.61, "slashleft_twohanded_y2", 20, 44, blend_in_release],
   [0.60, "slashleft_twohanded_y3", 18, 40, blend_in_release],
   [0.57, "slashleft_twohanded_y4", 23, 37, blend_in_release],
 ],
 ["release_slashleft_twohanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   [0.0, "slashleft_twohanded", 38, 52, blend_in_continue],
 ],
 ...
 ["ready_thrust_twohanded", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
   ...
   [ready_durn, "anim_human", 25470, 25450, blend_in_ready],
   [ready_durn, "attacks_thrust_twohanded_y", 0, 6, blend_in_ready],
   [ready_durn, "attacks_thrust_twohanded_y", 0, 7, blend_in_ready],
   [ready_durn, "attacks_thrust_twohanded_y", 0, 8, blend_in_ready],
   [ready_durn, "attacks_thrust_twohanded_y2", 1, 4, blend_in_ready],
 ],
 ["release_thrust_twohanded", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
   ...
   [0.61, "brfedit-01", 25450, 25485, blend_in_release],
   [0.55, "attacks_thrust_twohanded_y", 5, 11, blend_in_release],
   [0.61, "attacks_thrust_twohanded_y2", 8, 32, blend_in_release],
 ],
 ["release_thrust_twohanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   [0.5, "attacks_thrust_twohanded_y", 12, 15, blend_in_continue],
   [0.35, "attacks_thrust_twohanded_y2", 32, 43, blend_in_continue],
 ],
 ...
 ["ready_overswing_twohanded", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
   ...
   [ready_durn, "attacks_twohanded_overswing2", 11, 24, blend_in_ready],
   [ready_durn, "attacks_twohanded_overswing3", 11, 30, blend_in_ready],
   [ready_durn, "ani_twohanded_y", 11, 29, blend_in_ready],
 ],
 ["release_overswing_twohanded", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
   [0.61, "attacks_twohanded_overswing", 26, 56, blend_in_release],
   [0.65, "attacks_twohanded_overswing_y", 25, 65, blend_in_release],
   [0.61, "attacks_twohanded_overswing_y4", 26, 58, blend_in_release],
 ],
 ["release_overswing_twohanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   [0.3, "attacks_twohanded_overswing_yx", 65, 70, blend_in_continue],
 ],
 ["blocked_overswing_twohanded", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
   [attack_blocked_duration, "attacks_twohanded_overswing_y4", 42, 38, blend_in_parry],
 ],
 ["parried_overswing_twohanded", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
   [attack_parried_duration, "attacks_twohanded_overswing_y", 41, 39, blend_in_parry],
 ],
...
##   [ready_durn, "anim_human", combat+8500, combat+8510, blend_in_ready],
   [ready_durn, "anim_human", 28500, 28510, blend_in_ready],
   [ready_durn, "anim_human", 29500, 29510, blend_in_ready],
   [ready_durn, "attacks_thrust_onehanded", 5, 13, blend_in_ready],
   [0.25, "attacks_thrust_onehanded_y2", 1, 7, blend_in_ready],
   [0.25, "attacks_thrust_onehanded_y2", 38, 36, blend_in_ready],
   [ready_durn, "attacks_thrust_onehanded_y4", 3, 7, blend_in_ready],
 ],
...
##   [0.61, "anim_human", combat+8510, combat+8540, blend_in_release],
   ...
   [0.63, "attacks_thrust_onehanded_y2", 5, 26, blend_in_release],
   [0.59, "attacks_thrust_onehanded_y3", 13, 22, blend_in_release],
   [0.63, "attacks_thrust_onehanded_y5", 15, 37, blend_in_release],
 ],
 ["release_thrust_onehanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust|amf_client_owner_prediction,
   [0.5, "attacks_thrust_onehanded_y2", 12, 5, blend_in_continue],
   [0.4, "attacks_thrust_onehanded_y3", 23, 29, blend_in_continue],
 ],
...
##   [0.9, "attacks_thrust_onehanded", 16, 54, blend_in_release],
   [0.62, "attacks_thrust_twohanded_y2", 12, 32, blend_in_release],
   [0.63, "attacks_thrust_onehanded_y2", 5, 26, blend_in_release],
   [0.63, "attacks_thrust_onehanded_y5", 15, 37, blend_in_release],
 ],
...
##   [0.1, "attacks_thrust_onehanded", 54, 54, blend_in_continue],
   [0.4, "attacks_thrust_twohanded_y2", 34, 48, blend_in_continue],
   [0.45, "attacks_thrust_onehanded_y2", 12, 5, blend_in_continue],
 ],
...
##   [ready_durn, "anim_human", combat+9500, combat+9508, blend_in_ready],
   ...
   [0.25, "attacks_thrust_onehanded_y2", 1, 7, blend_in_ready],
   [ready_durn, "attacks_thrust_onehanded_y4", 3, 7, blend_in_ready],
   [ready_durn, "attacks_thrust_onehanded_y5", 3, 15, blend_in_ready],
 ],
...
##   [0.62, "anim_human", combat+9507, combat+9530, blend_in_release],
   ...
   [0.63, "attacks_thrust_onehanded_y4", 8, 25, blend_in_release],
   [0.63, "attacks_thrust_onehanded_y5", 15, 37, blend_in_release],
 ],
...
##   [0.1, "anim_human", combat+9530, combat+9540, blend_in_continue],
   [0.4, "thrust_onehanded_lance_hb", 41, 53, blend_in_continue],
   [0.5, "attacks_thrust_onehanded_y2", 12, 5, blend_in_continue],
 ],
...
##   [ready_durn, "attacks_single_righttoleft", 5, 10, blend_in_ready],
   ...
   [ready_durn, "attacks_single_righttoleft_v7", 8, 16, blend_in_ready],
   [ready_durn, "attacks_single_righttoleft_horseback2", 8, 15, blend_in_ready],
   [ready_durn, "parry_attack_slashright_onehanded", 16, 23, blend_in_ready],
   [ready_durn, "attacks_single_righttoleft_y", 11, 7, blend_in_ready],
   [ready_durn, "parry_attack_slashright_onehanded_y", 15, 20, blend_in_ready],
 ],
...
##   [0.6, "attacks_single_righttoleft", 10, 26, blend_in_release],
   ...
   [0.58, "slashright_onehanded_y", 23, 39, blend_in_release],
   [0.6, "attacks_single_righttoleft_v7", 16, 37, blend_in_release],
   [0.6, "attacks_single_righttoleft_horseback2", 17, 39, blend_in_release],
   [0.58, "attacks_single_righttoleft_y", 4, 24, blend_in_release],
   [0.6, "parry_attack_slashright_onehanded", 21, 46, blend_in_release],
   [0.55, "parry_attack_slashright_onehanded_y", 24, 43, blend_in_release],
 ],
...
##   [0.4, "attacks_single_righttoleft", 26, 43, blend_in_continue],
   [0.0, "attacks_single_righttoleft", 28, 44, blend_in_continue],
   [0.0, "attacks_single_righttoleft", 28, 44, blend_in_continue],
   [1.2, "parry_attack_slashright_onehanded_y", 41, 61, blend_in_continue],
   [0.0, "attacks_single_righttoleft", 28, 44, blend_in_continue],
 ],
...
##   [attack_parried_duration, "anim_human", combat+8820, combat+8815, blend_in_parry],
   [attack_blocked_duration, "attacks_single_righttoleft", 25, 19, blend_in_parry],
 ],
...
##   [ready_durn, "attacks_single_lefttoright", 12, 21, blend_in_ready],
   ...
   [ready_durn, "attacks_single_lefttoright_v7", 9, 19, blend_in_ready],
   [ready_durn, "parry_single_lefttoright", 15, 51, blend_in_ready],
   [ready_durn, "attacks_single_lefttoright_horseback", 8, 19, blend_in_ready],
   [ready_durn, "parry_attack_slashleft_onehanded_y2", 31, 26, blend_in_ready],
   [ready_durn, "attacks_single_lefttoright_y", 1, 4, blend_in_ready],
 ],
...
##   [0.61, "attacks_single_lefttoright", 21, 40, blend_in_release],
   ...
   [0.54, "parry_attack_slashleft_onehanded", 27, 43, blend_in_release],
   [0.58, "parry_attack_slashleft_onehanded_y2", 27, 43, blend_in_release],
   [0.57, "attacks_single_lefttoright_y", 4, 27, blend_in_release],
   [0.60, "attacks_single_lefttoright_horseback", 21, 43, blend_in_release],
 ],
...
##   [0.4, "attacks_single_lefttoright", 40, 50, blend_in_continue],
   [0.0, "attacks_single_lefttoright", 29, 43, blend_in_continue],
   [0.0, "attacks_single_lefttoright", 29, 43, blend_in_continue],
   [0.7, "attacks_single_righttoleft_y", 32, 57, blend_in_continue],
   [0.0, "attacks_single_lefttoright", 29, 43, blend_in_continue],
 ],
...
##   [attack_blocked_duration, "anim_human", combat+9120, combat+9115, blend_in_parry],
   [attack_blocked_duration, "parry_attack_slashleft_onehanded_y2", 33, 29, blend_in_parry],
 ],
...
##   [ready_durn, "attacks_single_overswing", 2, 16, blend_in_ready],
   ...
   [0.40, "parry_attack_slashright_onehanded_y", 62, 53, blend_in_ready],
   [0.40, "brfedit-01", 20004, 20017, blend_in_ready],
   [ready_durn, "throw_knife", 13, 23, blend_in_ready],
   [ready_durn, "throw_knife", 10, 19, blend_in_ready],
   [ready_durn, "throwing_axe", 5, 19, blend_in_ready],
   [ready_durn, "throwing_axe", 60, 63, blend_in_ready],
   [ready_durn, "attacks_single_overswing_y2", 6, 16, blend_in_ready],
   [ready_durn, "attacks_single_overswing_y3", 6, 16, blend_in_ready],
   [ready_durn, "attacks_single_overswing_y4", 6, 16, blend_in_ready],
 ],
...
##   [0.6, "attacks_single_overswing", 16, 35, blend_in_release],
   ...
   [0.6, "parry_attack_overswing_onehanded_y", 26, 42, blend_in_release],
   [0.64, "attacks_single_overswing_y", 17, 34, blend_in_release],
   [0.6, "attacks_single_overswing_y3", 16, 37, blend_in_release],
 ],
 ["release_overswing_onehanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_overswing|amf_client_owner_prediction,
   [0.0, "attacks_single_overswing", 37, 40, blend_in_continue],
 ],
 ["blocked_overswing_onehanded", acf_enforce_rightside, amf_priority_blocked|amf_use_weapon_speed|amf_play|amf_rider_rot_overswing,
   [attack_blocked_duration, "attacks_single_overswing_y", 24, 21, blend_in_parry],
 ],
 ["parried_overswing_onehanded", acf_enforce_rightside, amf_priority_parried|amf_use_weapon_speed|amf_play|amf_rider_rot_overswing,
   [attack_parried_duration, "attacks_single_overswing_y3", 24, 21, blend_in_parry],
 ],
...
##   [ready_durn, "attacks_single_righttoleft_horseback", 8, 16, blend_in_ready],
   ...
   [ready_durn, "attacks_single_righttoleft_v7", 8, 16, blend_in_ready],
   [ready_durn, "parry_attack_slashright_onehanded", 16, 23, blend_in_ready],
   [ready_durn, "parry_attack_slashright_onehanded_y", 16, 25, blend_in_ready],
 ],
...
##   [0.6, "attacks_single_righttoleft_horseback", 16, 38, blend_in_release],
   ...
   [0.68, "slashright_onehanded_y", 23, 39, blend_in_release],
   [0.7, "attacks_single_righttoleft", 5, 28, blend_in_release],
   [0.7, "slashright_twohanded", 18, 38, blend_in_release],
  ],
 ["release_slash_horseback_right_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right|amf_client_owner_prediction,
   [0.0, "attacks_single_righttoleft_horseback", 39, 54, blend_in_continue],
   [1.2, "parry_attack_slashright_onehanded_y", 41, 61, blend_in_continue],
   [0.0, "attacks_single_righttoleft_horseback", 39, 54, blend_in_continue],
   [0.0, "attacks_single_righttoleft_horseback", 39, 54, blend_in_continue],
  ],
...
#   [0.6, "anim_human", combat+9110, combat+9140, blend_in_release],
   ...
   [0.7, "attacks_single_lefttoright", 11, 29, blend_in_release],
   [0.65, "parry_attack_slashleft_onehanded", 27, 43, blend_in_release],
 ],
 ["release_slash_horseback_left_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left|amf_client_owner_prediction,
   [0.0, "attacks_single_lefttoright_horseback", 43, 51, blend_in_continue],
   [0.0, "attacks_single_lefttoright_horseback", 43, 51, blend_in_continue],
   [0.0, "attacks_single_lefttoright_horseback", 43, 51, blend_in_continue],
 ],
...
["ready_slash_horseback_polearm_right", acf_right_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_right,
   ...
   [ready_durn, "attacks_staff_righttoleft", 6, 18, blend_in_ready],
   [ready_durn, "attacks_staff_righttoleft_y", 6, 17, blend_in_ready],
 ],
 ["release_slash_horseback_polearm_right", acf_right_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right|amf_continue_to_next,
   ...
   [0.7, "attacks_staff_righttoleft_y", 20, 42, blend_in_release],
   [0.68, "attacks_staff_righttoleft_y2", 17, 33, blend_in_release],
   [0.73, "attacks_staff_righttoleft_y2", 14, 46, blend_in_release],
  ],
 ["release_slash_horseback_polearm_right_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right|amf_client_owner_prediction,
   [0.0, "attacks_staff_righttoleft", 40, 48, blend_in_continue],
   [1.2, "parry_attack_slashright_onehanded_yb2x", 41, 58, blend_in_continue],
   [0.0, "attacks_staff_righttoleft", 40, 48, blend_in_continue],
  ],
 ...
 ["ready_slash_horseback_polearm_left", acf_left_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_left,
   ...
   [ready_durn, "attacks_staff_lefttoright_y", 6, 21, blend_in_ready],
   [ready_durn, "attacks_staff_lefttoright_y2", 6, 19, blend_in_ready],
 ],
 ["release_slash_horseback_polearm_left", acf_left_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left|amf_continue_to_next,
   ...
   [0.7, "attacks_staff_lefttoright_y2", 20, 45, blend_in_release],
   [0.7, "attacks_staff_lefttoright_y4", 20, 45, blend_in_release],
 ],
 ["release_slash_horseback_polearm_left_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left|amf_client_owner_prediction,
   [0.0, "attacks_staff_lefttoright", 41, 55, blend_in_continue],
 ],
 ...
 ["ready_overswing_staff", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  ...
  [ready_durn, "attacks_staff_uptodown_y2", 11, 21, blend_in_ready],
  [ready_durn, "attacks_staff_uptodown_y3", 12, 21, blend_in_ready],
 ],
 ["release_overswing_staff", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
  ...
  [0.61, "attacks_staff_uptodown_y", 25, 54, blend_in_release],
  [0.61, "attacks_staff_uptodown_y2", 22, 51, blend_in_release],
  [0.62, "attacks_staff_uptodown_y3", 21, 46, blend_in_release],
 ],
 ["release_overswing_staff_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  [0.0, "attacks_staff_uptodown", 61, 68, blend_in_continue],
 ],
 ["blocked_overswing_staff", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
   [attack_blocked_duration, "attacks_staff_uptodown_y", 47, 44, arf_blend_in_2],
 ],
 ["parried_overswing_staff", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
   [attack_parried_duration, "attacks_staff_uptodown_y2", 29, 24, arf_blend_in_2],
 ],
 ["ready_thrust_staff", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
   ...
   [ready_durn, "attacks_thrust_staff_y", 9, 6, blend_in_ready],
   [ready_durn, "attacks_thrust_staff_y3", 12, 23, blend_in_ready],
   [ready_durn, "attacks_thrust_staff_y3", 12, 28, blend_in_ready],
   [ready_durn, "attacks_staff_thrust_overhead", 12, 20, blend_in_ready],
 ],
 ["release_thrust_staff", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play,
   ...
   [0.55, "attacks_thrust_staff_y", 6, 15, blend_in_release],
   [0.59, "attacks_thrust_staff_y3", 25, 42, blend_in_release],
   [0.64, "attacks_thrust_staff_y3", 25, 46, blend_in_release],
   [0.63, "anim_human", 27307, 27333, blend_in_release],
   [0.55, "attacks_staff_thrust_overhead", 22, 46, blend_in_release],
 ],
 ["release_thrust_staff_continue", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   [0.5, "attacks_staff_thrust", 48, 58, blend_in_release],
   [0.5, "attacks_thrust_staff_y3", 43, 55, blend_in_release],
   [0.4, "attacks_thrust_staff_y", 43, 55, blend_in_release],
 ],
...
##   [0.6, "attacks_staff_lefttoright", 20, 48, arf_blend_in_0],
   ...
   [0.58, "attacks_staff_lefttoright_y", 20, 43, blend_in_release],
   [0.6, "attacks_staff_lefttoright_y2", 20, 45, blend_in_release],
   [0.6, "attacks_staff_lefttoright_y4", 20, 45, blend_in_release],
 ],
 ["release_slashleft_staff_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   [0.0, "attacks_staff_lefttoright", 44, 55, blend_in_continue],
 ],
 ["blocked_slashleft_staff",acf_rot_vertical_bow|acf_anim_length(100), amf_priority_blocked|amf_use_weapon_speed|amf_play,
   [attack_blocked_duration, "attacks_staff_lefttoright_y4", 32, 28, arf_blend_in_2],
 ],
...
##   [0.6, "attacks_staff_righttoleft", 18, 48, arf_blend_in_0],
   ...
   [0.6, "attacks_staff_righttoleft_y", 20, 42, blend_in_release],
   [0.56, "attacks_staff_righttoleft_y2", 17, 33, blend_in_release],
   [0.64, "attacks_staff_righttoleft_y2", 14, 46, blend_in_release],
   [0.56, "attacks_staff_righttoleft_y3", 16, 38, blend_in_release],
   [0.55, "attacks_staff_righttoleft_y4", 20, 36, blend_in_release],
   [0.56, "attacks_staff_righttoleft_y5", 20, 36, blend_in_release],
 ],
 ...
 ["blocked_slashright_staff",acf_rot_vertical_bow|acf_anim_length(100), amf_priority_blocked|amf_use_weapon_speed|amf_play,
   [attack_blocked_duration, "attacks_staff_righttoleft_y", 31, 27, arf_blend_in_2],
 ],
...
#   [defend_duration, "defend_shield_parry_all", 5, 26, blend_in_defense],
 ...
 ["defend_shield_keep", acf_parallels_for_look_slope|acf_anim_length(100), amf_rider_rot_shield|amf_priority_defend|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
   ...
   [22, "defend_shield_y2", 3, 4, arf_blend_in_4|arf_cyclic],
 ],
...
#   [0.3, "anim_human", defend+320, defend+330, arf_blend_in_1],
 ...
 ["defend_right_twohanded_keep", 0, amf_priority_defend|amf_use_defend_speed|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
   [4.0, "anim_human", 35520, 35520, arf_blend_in_3|arf_cyclic],
   [4.0, "slashleft_twohanded0", 38, 38, arf_blend_in_3|arf_cyclic],
   [4.0, "slashleft_twohanded3", 9, 9, arf_blend_in_3|arf_cyclic],
   [4.0, "slashleft_twohanded_y2", 12, 12, arf_blend_in_3|arf_cyclic],
 ],
 ["defend_right_twohanded_parry_1", 0, amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_defend,
   [0.6, "slashleft_twohanded0", 38, 36, arf_blend_in_1],
   [0.6, "slashleft_twohanded3", 9, 11, arf_blend_in_1],
   [0.5, "slashleft_twohanded_y", 29, 33, arf_blend_in_1],
   [0.5, "ani_twohanded_y", 92, 99, arf_blend_in_1],
 ],
 ...
 ["defend_left_twohanded_keep", 0, amf_priority_defend|amf_use_defend_speed|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
   [4.0, "anim_human", 35620, 35620, arf_blend_in_3|arf_cyclic],
   [4.0, "slashleft_twohanded2", 17, 19, arf_blend_in_3|arf_cyclic],
   [4.0, "anim_human", 35660, 35660, arf_blend_in_3|arf_cyclic],
 ],
 ["defend_left_twohanded_parry_1", 0, amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_defend,
   [0.6, "slashleft_twohanded2", 19, 14, arf_blend_in_1],
   [0.6, "anim_human", 35660, 35677, arf_blend_in_1],
   [0.5, "slashright_twohanded_y4", 24, 30, arf_blend_in_1],
 ],
...
##   [defend_duration, "defend_onehanded", 8, 15, blend_in_defense],
   [0.35, "defend_forward_onehanded", 1, 6, 6],
...
#   [2.0, "anim_human", defend+1020, defend+1020, arf_blend_in_3|arf_cyclic],
   [10.0, "defend_forward_onehanded_parry", 25, 78, arf_blend_in_3|arf_cyclic],
 ],
...
#   [0.3, "anim_human", defend+1021, defend+1030, arf_blend_in_1],
   ...
   [defend_parry_duration_1, "defend_forward_onehanded", 16, 46, 2],
...
##   [defend_keep_duration, "anim_human", defend+1120, defend+1120, arf_blend_in_3|arf_cyclic],
   ...
   [2.5, "defend_up_onehanded_parry", 21, 44, 6],
 ],
 ["defend_up_onehanded_parry_1", 0, amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_defend,
   ...
   [defend_parry_duration_1, "defend_up_onehanded", 8, 45, 6],
...
##   [defend_keep_duration, "anim_human", defend+1220, defend+1220, arf_blend_in_5|arf_cyclic],
   [4.0, "defend_right_onehanded_keep", 0, 79, arf_blend_in_5|arf_cyclic],
   [4.0, "defend_right_onehanded_parry", 13, 32, arf_blend_in_5|arf_cyclic],
   [1.3, "defend_right_onehanded_keep_y", 2, 23, 7],
 ],
 ["defend_right_onehanded_parry_1", 0, amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_defend,
   ...
   [defend_parry_duration_1, "defend_right_onehanded", 14, 35, arf_blend_in_1],
   [defend_parry_duration_1, "parry_attack_slashright_onehanded_y", 54, 60, arf_blend_in_1],
...
##   [defend_keep_duration, "anim_human", defend+1320, defend+1320, arf_blend_in_3|arf_cyclic],
   [4.2, "defend_left_onehanded_keep", 1, 71, arf_blend_in_3|arf_cyclic],
   [4.2, "defend_left_onehanded_parry", 14, 29, arf_blend_in_3|arf_cyclic],
   [4.0, "attacks_single_lefttoright_v7", 11, 11, arf_blend_in_3|arf_cyclic],
 ],
 ["defend_left_onehanded_parry_1", 0, amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_defend,
   ...
   [defend_parry_duration_1, "attacks_single_lefttoright_v7", 10, 7, arf_blend_in_1],
   [defend_parry_duration_1, "defend_left_onehanded", 12, 41, arf_blend_in_1],
...
#   [0.3, "anim_human", defend+2021, defend+2030, arf_blend_in_1],
   ...
   [0.4, "attacks_staff_lefttoright_y", 30, 33, arf_blend_in_1],
 ],
...
#   [0.3, "anim_human", defend+2021, defend+2030, arf_blend_in_1],
 ...
 ["defend_up_staff_keep", 0, amf_priority_defend|amf_use_defend_speed|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
   ...
   [1.2, "stand_staff_y", 6, 22, arf_blend_in_3|arf_cyclic],
 ],
 ["defend_up_staff_parry_1", 0, amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_defend,
   ...
   [defend_parry_duration_1, "stand_staff_y", 8, 14, 4],
 ],
 ...
 ["defend_right_staff_parry_1", 0, amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_defend,
   ...
   [0.4, "attacks_staff_lefttoright_y2", 30, 36, arf_blend_in_1],
 ],
 ...
 ["defend_left_staff_parry_1", 0, amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_defend,
   ...
   [0.4, "attacks_staff_lefttoright_y", 32, 27, arf_blend_in_1],
   [0.4, "attacks_staff_righttoleft_y4", 27, 34, arf_blend_in_1],
 ],
...
## ],
 ...
 ["strike3_abdomen_right", acf_enforce_all, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   ...
   [1.1, "strikes3_y", 68, 98, 4, 0, (0, 0.0, 0.0)],
 ],
 ["strike3_abdomen_front", acf_enforce_all, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   ...
   [1.1, "strikes3_y", 10, 38, arf_blend_in_3,  0, (0, 0.0, 0.0)],
 ],
...
#   [0.6,  "anim_human", blow+5200, blow+5220, arf_blend_in_3],
 ...
 ["fall_face_hold", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [0.9, "anim_human", 40247, 40275, 9, 0, (0.8,-1.8,0), 0.5],
   [2.0, "fall_rider_right_forward", 13, 64, 516, 204, (0,0,0), 0.3],
   [1.18, "strikes3_head", 208, 241, 2, 0, (0,0,0), 0],
 ],
 ["fall_chest_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [0.7, "strike_down_y2x", 9, 18, 9, 0, (-0.4,0.2,0), 1],
   [0.4, "strike_down_y", 0, 10, 9, 0, (-0.4,0.2,0), 1],
   [0.5, "strike_down_yb", 0, 12, 9, 0, (-0.4,0.2,0), 1.0],
   [1.0, "death_chest", 4, 37, 529, 229, (0,0,0), 0.5],
   [1.0, "anim_human", 40255, 40275, 9, 0, (0.8,-1.8,0), 0.5],
   [0.9, "strikes3_chest", 61, 93, 4, 0, (0,0,0), 0.0],
 ],
 ["fall_abdomen_hold_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [1.0, "death_back_y", 35, 61, 529, 53623, (0,0,0), 1.5],
   [1.3, "strikes3_abdomen_y", 1, 25, 529, 53623, (0,0,0), 1.5],
   [2.7, "death_abdomen", 5, 96, 529, 102, (0,0,0), 0.5],
   [1.2, "anim_human", 45400, 45427, 3,0, (0,0,0), 0.0],
   [1.7, "death_abdomen", 15, 41, 529, 102, (0,0,0), 0.5],
 ],
 ["fall_head_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [1.8, "fall_rider_right_forward", 20, 68, 516, 204, (0,0,0), 0.3],
   [1.2, "anim_human", 40100, 40138, 529, 204, (0,0,0), 0.8],
   [1.0, "anim_human", 40227, 40275, 9, 0, (0.8,-1.8,0), 0.5],
   [1.6, "anim_human", 45400, 45427, 3, 0, (0,0,0), 0.0],
   [2.4, "fall_rider_right_forward", 31, 68, 529, 127, (0,0,0), 0.6],
   [2.2, "death2_y", 14, 50, 529, 229, (0,0,0), 0.5],
   [0.9, "strikes3_head", 14, 48, 4, 0, (0,0,0), 0.0],
 ],
 ["fall_right_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [2.6, "fall_rider_right", 35, 61, 516, 204, (0,0,0), 0.3],
   [0.90, "death2", 0, 29, 529, 165, (0,0,0), 1.0],
   [0.65, "anim_human_02", 350, 376, 9, 0, (0.8,-1.8,0), 0.5],
   [0.7, "anim_human_02", 360, 370, 9, 0, (0.8,-1.8,0), 0.5],
   [0.7, "strike_down_y2x", 12, 21, 9, 0, (-0.4,0.2,0), 1.0],
   [1.0, "death_face_y", 2, 13, 9, 0, (-0.4,0.2,0), 1.0],
   [0.9, "strikes3_abdomen", 105, 150, 4, 0, (0,0,0), 0.0],
   [1.48, "strikes3_head", 208, 248, 2, 0, (0,0,0), 0.0],
 ],
 ["fall_body_back", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [1.2, "death_back_y2", 14, 40, 515, 102, (0,0,0), 0.5],
   [1.2, "death_back_y2", 15, 47, 515, 102, (0,0,0), 0.5],
   [0.8, "death_back_y", 35, 48, 515, 102, (0,0,0), 0.5],
   [1.0, "death_back_y", 34, 61, 515, 102, (0,0,0), 0.5],
   [2.7, "death", 0, 83, 529, 53623, (0,0,0), 1.5],
   [1.0, "anim_human", 42000, 42065, 9, 0, (0.8,-1.8,0), 0.5],
   [2.0, "fall_rider_right", 33, 61, 516, 204, (0,0,0), 0.3],
   [1.2, "strikes3_abdomen_back", 0, 48, 4, 0, (0,0,0), 0.0],
 ],
...
## ],
 ["fall_rider_right_forward", acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [3.2, "fall_rider_right_forward", 0, 66, 529, 127, (0,0,0), 0.6],
   [2.2, "anim_human", 40200, 40275, 516, 204, (0,0,0), 0.3],
   [2.0, "anim_human_02", 350, 372, 9, 0, (0.8,-1.8,0), 0.5],
   [1.95, "anim_human", 40237, 40275, 9, 0,(0.8,-1.8,0), 0.5],
   [1.80, "anim_human", 41518, 41542, 9, 0, (0.8,-1.8,0), 0.5],
   [2.0, "fall_rider_right_forward", 6, 27, 516, 204, (0,0,0), 0.3],
   [1.0, "death_face_y", 3, 13, 529, 127, (0,0,0), 0.6],
##   [2.2, "fall_rider_right_forward", 0, 68, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3],
 ...
 ["fall_rider_right", acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [1.9, "fall_rider_right",  0, 57, 516, 204, (0,0,0), 0.3],
##   [1.9, "fall_rider_right", 0, 57, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3],
 ...
 ["fall_rider_left", acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3],
   [1.9, "fall_rider_left", 0, 50, 516, 204, (0,0,0), 0.3],
...
## ],
 ...
 ["rider_fall_roll", acf_enforce_all|acf_displace_position, amf_priority_fall_from_horse|amf_play|amf_accurate_body|amf_client_prediction,
   ...
   [1.95, "anim_human", 42000, 42084, 9, 0, (-0.4, 0.2,0), 1.0],
   [2.3, "fall_rider_right", 0, 57, 516, 204, (0.0,0.0,0), 0.3],
   [2.0, "fall_rider_left", 0, 50, 516, 204, (0.0,0.0,0), 0.3],
   [2.5, "fall_rider_right_forward", 0, 66, 516, 204, (0.0,0.0,0), 0.3],
 ],
 ...
 ["strike_fall_back_rise", 17408, 58720337,
   [1.7, "anim_human", 45400, 45453, 515, 102, (0,0,0), 0.5],
   [1.7, "anim_human_02", 353, 382, 9, 0, (0.8,-1.8,0), 0.5],
   [1.5, "anim_human", 41525, 41552, 9, 0, (0.8,-1.8,0), 0.5],
   [1.8, "strike_down_y2x", 8, 25, 9, 0, (0.8,-1.8,0), 0.5],
   [1.7, "strike_down_y", 2, 17, 9, 0, (0.8,-1.80,0), 0.5],
   [1.7, "strike_down_yb", 1, 16, 9, 0, (0.8,-1.80,0), 0.5],
 ],
 ["strike_fall_back_rise_upper", 17408, 58720337,
   [1.7, "anim_human", 45400, 45453, 3],
   [1.7, "anim_human_02", 353, 382, 3],
   [1.5, "anim_human", 41525, 41552, 3],
   [1.8, "strike_down_y2x", 8, 25, 3],
   [1.7, "strike_down_y", 1, 17, 3],
   [1.7, "strike_down_yb", 1, 16, 3],
 ],
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5],
 ...
 ["ready_overswing_spear", 1679294464, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
	[ready_durn, "attacks_staff_thrust_overhead", 0, 20, blend_in_ready],
 ],
 ["release_overswing_spear", 1679294464, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
 	[0.6, "attacks_staff_thrust_overhead", 20, 41, blend_in_release],
 ],
 ["release_overswing_spear_continue", 1677721600, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   [0.3, "attacks_staff_thrust_overhead", 41, 52, arf_blend_in_2],
 ],
 ["parried_overswing_spear", 1678770176, amf_priority_parried|amf_use_weapon_speed|amf_play,
   [0.3, "attacks_staff_thrust_overhead", 26, 22, arf_blend_in_2],
 ],
 ["blocked_overswing_spear", 1678770176, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [0.3, "attacks_staff_thrust_overhead", 26, 22, arf_blend_in_2],
],
 ...
 ["unused_human_anim_44", 17408, 58720337, [2.1, "anim_human", 40200, 40275, 516, 204,(0,0,0),0.3]],
 ["unused_human_anim_45", 17408, 58720337, [2.8, "anim_human_02", 350, 382, 9, 0, (0.800000, -1.800000, 0.000000), 0.500000]],
 ["unused_human_anim_46", 17408, 192938065, [3.0, "anim_human", 42000, 42084, 9]],
 ["unused_human_anim_47", 1026, 176160848, [2.2, "anim_human", 45400, 45453, 515]],
 ["unused_human_anim_48", 1024, 176160848, [0.9, "strikes3_head", 14, 48, 4]],
 ["unused_human_anim_49", 1024, 176160848, [0.9, "strikes3_head", 309, 346, 4]],
 ["unused_human_anim_50", 1024, 176160848, [0.9, "strikes3_abdomen", 105, 150, 4]],
 ["unused_human_anim_51", 1024, 176160848, [0.9, "strikes3_abdomen", 4, 43, 4]],
 ["unused_human_anim_52", 1024, 176160848, [1.0, "fjcy", 0, 52, 2]],
 ["unused_human_anim_53", 1024, 176160848, [0.35, "uppercut", 0, 17, 7]],
 ["unused_human_anim_54", 1024, 176160848, [0.5, "uppercut",17, 34, 6]],
 ["unused_human_anim_55", 1026, 176160848, [5.0, "anim_human", 45400, 45453, 515]],
 ["unused_human_anim_56", 1024, 176160848, [19, "stand_guardsman", 1650, 2000, 1342177280,0,(0.000000, 0.000000, 0.000000),0.250000]],
 ["unused_human_anim_57", 1677725952, 604024846, [2.0, "anim_human", 35118, 35120, 268435461]],
 ["unused_human_anim_58", 1024, 176160848, [2.0, "sword_loop01", 0, 10, 1342177280,0,(0.000000, 0.000000, 0.000000),0.250000]],
 ["unused_human_anim_59", 1024, 176160848, [1.0, "parry_attack_slashleft_onehanded", 1, 55, 7]],
...
##   [2.5, "anim_horse", 505, 580,  arf_blend_in_8],
 ...
 ["unused_horse_anim_1", 0, 16778240,
  [1.0, "anim_horse", 600, 644, 1342177280],
  [1.0, "anim_horse", 600, 644, 1342177280],
  [1.0, "anim_horse", 600, 644, 1342177280],
],
